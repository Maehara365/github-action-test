...
program.arguments("<taskName>").action(async (taskName) => {
  const tasks = program.taskfile
    ? require(path.resolve(program.taskfile))
    : defaultTask;
  utr.setTasks(tasks);
...
console.log(chalk.bold.greenBright(" qtro task runner"));
console.log(chalk.bold.greenBright("====================================="));
